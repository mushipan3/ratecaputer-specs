...
- Connect AUDIO_MONO to R10 (100Ohm).
  Connect R10 opposite side to J1 Left Tip Pin.
- Connect AUDIO_MONO to R11 (100Ohm).
...
| # | 項目 | 優先度 | 備考 |
|---|---|---|---|
| 1 | ~~CS_YMF・RST_YMF・IRQ_NのCH32V003ピン番号確定~~ | ~~高~~ | **解消済み**（CS_YMF=PD2・RST_YMF/IRQ_Nは兼用/オプション） |
